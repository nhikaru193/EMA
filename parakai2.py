...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            # STEP 3: その場で回頭 (動的調整)
            print("\n=== ステップ3: 目標方位への回頭 (動的調整) ===")
            ANGLE_THRESHOLD_DEG = 20.0 # 許容誤差を20度に設定
            turn_speed = 55
            ...
            if red_location_result == 'left_bottom':
                ...
                turn_to_relative_angle(driver, bno_sensor, 120, turn_speed=50, angle_tolerance_deg=30.0) # 右120度
                ...
                # 3. 左に30度回頭
                turn_to_relative_angle(driver, bno_sensor, -30, turn_speed=50, angle_tolerance_deg=20.0) # 左に30度回頭 (許容誤差5度)
                ...
                print("待機後、少し前進します")
                following.follow_forward(driver, bno_sensor, base_speed=100, duration_time=3)
            ...
            turn_to_relative_angle(driver, bno_sensor, -30, turn_speed=55, angle_tolerance_deg=5.0) # 左30度
            ...
            print("→ 左30度から正面に戻します...")
            turn_to_relative_angle(driver, bno_sensor, 30, turn_speed=55, angle_tolerance_deg=5.0) # 右30度で戻す

            # 右30度
            print("→ 右に30度回頭し、赤色を確認します...")
            turn_to_relative_angle(driver, bno_sensor, 30, turn_speed=55, angle_tolerance_deg=5.0) # 右30度
            ...
            print("→ 右30度から正面に戻します...")
            turn_to_relative_angle(driver, bno_sensor, -30, turn_speed=55, angle_tolerance_deg=5.0) # 左30度で戻す
            ...
            if is_front_clear and is_left_clear and is_right_clear:
                ...
                if scan_results['left_30'] != 'none_detected': # 左30度で検出されたら右90度
                    ...
                    turn_to_relative_angle(driver, bno_sensor, 90, turn_speed=60, angle_tolerance_deg=20.0)
